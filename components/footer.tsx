...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#272b38] text-white">
      {/* 메인 푸터 */}
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="w-12 h-0.5 bg-[#651d2a] mb-4"></div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <MapPin className="w-4 h-4 text-[#651d2a] mt-1 flex-shrink-0" />
              ...
              <li className="flex items-center gap-3">
                <Phone className="w-4 h-4 text-[#651d2a] flex-shrink-0" />
                <div className="text-gray-300 text-sm">
                  <a href="tel:+82707556355" className="hover:text-white transition-colors">
                    +82 70 7556 5355
                  </a>
                  <br />
                  <a href="tel:+821024791242" className="hover:text-white transition-colors">
                    +82 10 2479 1242
                  </a>
                </div>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-[#651d2a] flex-shrink-0" />
                <a
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-2">
                <div className="flex">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <svg key={star} className="w-4 h-4 text-[#00AA6C]" fill="currentColor" viewBox="0 0 20 20">
