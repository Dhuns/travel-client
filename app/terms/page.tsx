          ...
          <div className="p-8 prose prose-gray max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                By accessing and using OneDayKorea's services, you agree to be bound by
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                Permission is granted to temporarily access the materials on OneDayKorea's
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                ...
                <li>
                  Attempt to reverse engineer any software contained on OneDayKorea's
                  website
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                OneDayKorea provides travel planning and booking services for tours and
                activities in South Korea. We act as an intermediary between travelers and
                service providers. All bookings are subject to availability and
                confirmation.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                ...
                and current information. Failure to do so constitutes a breach of the
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                All prices are displayed in the local currency and include applicable
                taxes unless otherwise stated. Payment is required at the time of booking.
                We accept various payment methods as displayed on our platform.
              </p>
              <p className="text-gray-700 leading-relaxed">
                Cancellation and refund policies vary by service provider and are clearly
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                OneDayKorea shall not be liable for any indirect, incidental, special,
                consequential or punitive damages resulting from your use of or inability
                to use the service. We do not guarantee the accuracy, completeness, or
                usefulness of any information provided by third-party service providers.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                provide notice of any significant changes by posting the new Terms on this
                page. Your continued use of the service after such modifications
                constitutes your acknowledgment and acceptance of the modified Terms.
              </p>
            </section>
