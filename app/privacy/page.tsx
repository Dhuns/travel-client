          ...
          <div className="p-8 prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                ...
                <li>With tour operators and activity providers to fulfill your bookings</li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                and to improve your experience on our website. You can control cookies through your browser settings.
              </p>
            </section>
