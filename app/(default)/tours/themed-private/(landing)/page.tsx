...
export default async function PrivateTourPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center w-full mx-auto bg-white">
      {/* Hero Section */}
        ...
        <div className="py-12 md:py-24 container mx-auto max-w-5xl px-6 relative z-10 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="#tour-list">
              <Button
                size="lg"
                className="max-w-[160px] bg-white text-tumakr-dark-blue hover:bg-white/90 font-semibold text-lg px-8 py-6 shadow-2xl hover:shadow-white/20 transition-all"
              >
                Explore Tours
              </Button>
            </Link>
            <Link href="#about">
              <Button
                size="lg"
                variant="outline"
                className="max-w-[160px] border-2 border-white text-white hover:bg-white/10 font-semibold text-lg px-8 py-6 backdrop-blur-sm transition-all"
              >
                Learn More
              </Button>
            </Link>
          ...
          <div className="mt-16 grid sm:grid-cols-3  grid-cols-1 rounded-xl p-6 gap-6 sm:max-w-3xl max-w-[300px] mx-auto">
            <div className="text-center bg-white/30 backdrop-blur-sm p-6 border rounded-xl border-white/20">
              <div className="text-4xl font-bold text-white mb-2">4.9★</div>
              <div className="text-white text-sm font-medium">Customer Rating</div>
            </div>
            <div className="text-center bg-white/30 backdrop-blur-sm p-6 border rounded-xl border-white/20">
              <div className="text-4xl font-bold text-white mb-2">700+</div>
              <div className="text-white text-sm font-medium">Happy Travelers</div>
            </div>
            <div className="text-center bg-white/30 backdrop-blur-sm p-6 border rounded-xl border-white/20">
              <div className="text-4xl font-bold text-white mb-2">8+</div>
              <div className="text-white text-sm font-medium">Unique Themes</div>
            </div>
          </div>
        </div>
      </section>
      <div className="max-w-7xl w-full mx-auto md:px-8 px-4">
        ...
        <section id="tour-list" className="py-24">
